...
dpkg-scanpackages --multiversion --arch amd64 pool/$repoName > dists/$repoName/binary-amd64/Packages

cat dists/$repoName/binary-amd64/Packages | gzip -9 > dists/$repoName/binary-amd64/Packages.gz
